...
NappingOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "NappingOptions",
...
NappingResults <- if (requireNamespace('jmvcore')) R6::R6Class(
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Image$new(
                ...
                name="plotind",
                visible="(modactillus)",
                title="Representation of the individuals and categorical supplementary variables",
                width=800,
                height=600,
...
NappingBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "NappingBase",
